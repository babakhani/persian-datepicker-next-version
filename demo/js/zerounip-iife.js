...
this.zerounip = (function () {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<DateView> was created with unknown prop '${key}'`);
    	});
    ...
    class DateView extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (ctx.viewUnix === undefined && !("viewUnix" in props)) {
    			console_1.warn("<DateView> was created without expected prop 'viewUnix'");
    		}

    		if (ctx.selectedUnix === undefined && !("selectedUnix" in props)) {
    			console_1.warn("<DateView> was created without expected prop 'selectedUnix'");
    		}

    		if (ctx.todayUnix === undefined && !("todayUnix" in props)) {
    			console_1.warn("<DateView> was created without expected prop 'todayUnix'");
    		}
    	}
    ...
    function create_if_block$1(ctx) {
    	...
    	let t1;
    	let current;
    	let if_block0 = ctx.viewMode === "year" && create_if_block_3$1(ctx);
    	let if_block1 = ctx.viewMode === "month" && create_if_block_2$1(ctx);
    	let if_block2 = ctx.viewMode === "date" && create_if_block_1$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "pwt-date-navigator-center");
    			add_location(div, file$4, 14, 2, 546);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_3$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 17, 4, 622);
    ...
    function create_if_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-navigator-button");
    			add_location(button, file$4, 26, 4, 898);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-navigator-button pwt-animated");
    			add_location(button, file$4, 35, 4, 1157);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path1, file$4, 53, 3, 1574);
    			attr_dev(svg1, "width", "20");
    			attr_dev(svg1, "height", "20");
    			attr_dev(svg1, "viewBox", "0 0 24 24");
    			add_location(svg1, file$4, 49, 2, 1512);
    			attr_dev(button1, "class", "pwt-date-navigator-next");
    			add_location(button1, file$4, 46, 1, 1446);
