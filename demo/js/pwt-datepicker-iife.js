    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!tbody_intro) tbody_intro = create_in_transition(tbody, /*fadeIn*/ ctx[7], { duration: /*animateSpeed*/ ctx[13] / 2 });
    				tbody_intro.start();
    			});
    		...
    		o: function outro(local) {
    			...
    			tbody_outro = create_out_transition(tbody, /*fadeOut*/ ctx[6], { duration: /*animateSpeed*/ ctx[13] / 2 });
    			current = false;
    		},
    		d: function destroy(detaching) {
