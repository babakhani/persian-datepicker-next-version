...
this['persian-datepicker-next-version'] = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isDisable, yearRange, currentYear, select, getPersianYear*/ 1413) {
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[20](/*year*/ ctx[21], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "disable", /*isDisable*/ ctx[7](/*year*/ ctx[21]));
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*isDisable, yearRange*/ 129) {
    				toggle_class(div, "disable", /*isDisable*/ ctx[7](/*year*/ ctx[21]));
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("currentViewYear" in $$props) $$invalidate(18, currentViewYear = $$props.currentViewYear);
    	};
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*$dateObject, viewUnix*/ 135168) {
    			 $$invalidate(18, currentViewYear = new $dateObject(viewUnix).year());
    		}

    		if ($$self.$$.dirty & /*currentViewYear, yearRange, startYear, viewUnix, cachedViewUnix, $config*/ 356353) {
    			 {
    ...
    class YearView extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { selectedUnix: 11, viewUnix: 12 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*isDisable, currentViewYear, currentMonth, currentSelectedYear, select, monthRange*/ 1566) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (div_outro) div_outro.end(1);
    				if (!div_intro) div_intro = create_in_transition(div, /*fadeIn*/ ctx[8], { duration: /*animateSpeed*/ ctx[11] });
    				div_intro.start();
    			});
    ...
    function create_each_block$1(ctx) {
    	...
    	function click_handler(...args) {
    		return /*click_handler*/ ctx[19](/*index*/ ctx[22], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(div, "disable", /*isDisable*/ ctx[9](/*currentViewYear*/ ctx[4], /*index*/ ctx[22] + 1));
    			toggle_class(div, "selected", /*currentMonth*/ ctx[2] - 1 === /*index*/ ctx[22] && /*currentViewYear*/ ctx[4] === /*currentSelectedYear*/ ctx[3]);
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*monthRange*/ 2 && t0_value !== (t0_value = /*month*/ ctx[20] + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*isDisable, currentViewYear*/ 528) {
    				toggle_class(div, "disable", /*isDisable*/ ctx[9](/*currentViewYear*/ ctx[4], /*index*/ ctx[22] + 1));
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$dateObject*/ 131072) {
    			 $$invalidate(1, monthRange = new $dateObject().rangeName().months);
    		}

    		if ($$self.$$.dirty & /*$dateObject, selectedUnix*/ 135168) {
    		...
    		if ($$self.$$.dirty & /*$dateObject, viewUnix*/ 139264) {
    			 $$invalidate(4, currentViewYear = new $dateObject(viewUnix).year());
    		}

    		if ($$self.$$.dirty & /*viewUnix, cachedViewUnix, $config*/ 90112) {
    			 {
    				if (viewUnix > cachedViewUnix) {
    					transitionDirectionForward = true;
    				} else {
    ...
    class MonthView extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { selectedUnix: 12, viewUnix: 13 });
    ...
    function create_each_block_2(ctx) {
    	let th;
    	let span;
    	let t0_value = /*day*/ ctx[28].format("ddd") + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*groupedDay*/ 1 && t0_value !== (t0_value = /*day*/ ctx[28].format("ddd") + "")) set_data_dev(t0, t0_value);
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*groupedDay, isDisable, checkDate, isSameDate, selectedDay, today, currentViewMonth, selectDate, getHintText, $config*/ 31805) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!tbody_intro) tbody_intro = create_in_transition(tbody, /*fadeIn*/ ctx[9], { duration: /*animateSpeed*/ ctx[15] / 2 });
    				tbody_intro.start();
    			});
    ...
    function create_if_block_2(ctx) {
    	let span;
    	let t0_value = /*day*/ ctx[28].format("D") + "";
    	let t0;
    	let t1;
    	let if_block_anchor;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 33, 10, 1036);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*groupedDay*/ 1 && t0_value !== (t0_value = /*day*/ ctx[28].format("D") + "")) set_data_dev(t0, t0_value);
    ...
    function create_if_block_3(ctx) {
    	let span;
    	let t_value = /*getHintText*/ ctx[14](/*day*/ ctx[28]) + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 37, 11, 1192);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			append_dev(span, t);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*groupedDay*/ 1 && t_value !== (t_value = /*getHintText*/ ctx[14](/*day*/ ctx[28]) + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(span);
    		}
    ...
    function create_each_block_1(ctx) {
    	let td;
    	let show_if = /*day*/ ctx[28] && /*day*/ ctx[28].month && /*day*/ ctx[28].format && /*currentViewMonth*/ ctx[5] === /*day*/ ctx[28].month();
    	let t;
    	let dispose;
    	let if_block = show_if && create_if_block_2(ctx);

    	function click_handler(...args) {
    		return /*click_handler*/ ctx[24](/*day*/ ctx[28], ...args);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			toggle_class(td, "othermonth", !/*day*/ ctx[28].month);
    			toggle_class(td, "disable", /*isDisable*/ ctx[12](/*day*/ ctx[28]) || !/*checkDate*/ ctx[11](/*day*/ ctx[28]));
    			toggle_class(td, "selected", /*day*/ ctx[28] && /*day*/ ctx[28].isPersianDate && /*isSameDate*/ ctx[10](/*day*/ ctx[28].valueOf(), /*selectedDay*/ ctx[3]));
    			toggle_class(td, "today", /*day*/ ctx[28] && /*day*/ ctx[28].isPersianDate && /*isSameDate*/ ctx[10](/*day*/ ctx[28].valueOf(), /*today*/ ctx[4]));
    			add_location(td, file$2, 25, 8, 514);
    		},
    		m: function mount(target, anchor, remount) {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty[0] & /*groupedDay, currentViewMonth*/ 33) show_if = /*day*/ ctx[28] && /*day*/ ctx[28].month && /*day*/ ctx[28].format && /*currentViewMonth*/ ctx[5] === /*day*/ ctx[28].month();
    			...
    			if (dirty[0] & /*isDisable, groupedDay, checkDate*/ 6145) {
    				toggle_class(td, "disable", /*isDisable*/ ctx[12](/*day*/ ctx[28]) || !/*checkDate*/ ctx[11](/*day*/ ctx[28]));
    			}

    			if (dirty[0] & /*groupedDay, isSameDate, selectedDay*/ 1033) {
    				toggle_class(td, "selected", /*day*/ ctx[28] && /*day*/ ctx[28].isPersianDate && /*isSameDate*/ ctx[10](/*day*/ ctx[28].valueOf(), /*selectedDay*/ ctx[3]));
    			}

    			if (dirty[0] & /*groupedDay, isSameDate, today*/ 1041) {
    				toggle_class(td, "today", /*day*/ ctx[28] && /*day*/ ctx[28].isPersianDate && /*isSameDate*/ ctx[10](/*day*/ ctx[28].valueOf(), /*today*/ ctx[4]));
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block$2(ctx) {
    	let tr;
    	let t;
    	let if_block = /*week*/ ctx[25].length > 1 && create_if_block_1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			if (if_block) if_block.c();
    			t = space();
    			add_location(tr, file$2, 22, 5, 446);
    		},
    		m: function mount(target, anchor) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	const dateObject = getContext("dateObject");
    	validate_store(dateObject, "dateObject");
    	component_subscribe($$self, dateObject, value => $$invalidate(22, $dateObject = value));
    	const config = getContext("config");
    	validate_store(config, "config");
    	...
    	$$self.$set = $$props => {
    		...
    		if ("todayUnix" in $$props) $$invalidate(18, todayUnix = $$props.todayUnix);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("cachedViewUnix" in $$props) $$invalidate(19, cachedViewUnix = $$props.cachedViewUnix);
    		if ("transitionDirectionForward" in $$props) transitionDirectionForward = $$props.transitionDirectionForward;
    		if ("animateTimer" in $$props) $$invalidate(21, animateTimer = $$props.animateTimer);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*$dateObject, selectedUnix*/ 4325376) {
    			 $$invalidate(3, selectedDay = new $dateObject(selectedUnix).startOf("day"));
    		}

    		if ($$self.$$.dirty[0] & /*$dateObject, todayUnix*/ 4456448) {
    			 $$invalidate(4, today = new $dateObject(todayUnix));
    		}

    		if ($$self.$$.dirty[0] & /*$dateObject, viewUnix*/ 4259840) {
    			 $$invalidate(5, currentViewMonth = new $dateObject(viewUnix).month());
    		}

    		if ($$self.$$.dirty[0] & /*$dateObject, viewUnix, $config, groupedDay, cachedViewUnix, animateTimer*/ 6881285) {
    			 {
    				...
    				if ($config.animate && new $dateObject(viewUnix).month() !== new $dateObject(cachedViewUnix).month()) {
    					...
    					$$invalidate(21, animateTimer = setTimeout(
    						() => {
    							$$invalidate(1, visible = true);
    						},
    						animateSpeed
    				...
    				$$invalidate(19, cachedViewUnix = viewUnix);
    			}
    		}
    	};
    ...
    class DateView extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*todayUnix*/ ctx[18] === undefined && !("todayUnix" in props)) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				...
    				listen_dev(div, "wheel", /*wheel_handler*/ ctx[17], false, false, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				...
    				listen_dev(button1, "click", /*click_handler_3*/ ctx[19], false, false, false),
    				listen_dev(div, "wheel", /*wheel_handler_1*/ ctx[20], false, false, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(button0, "click", /*click_handler_4*/ ctx[21], false, false, false),
    				listen_dev(button1, "click", /*click_handler_5*/ ctx[22], false, false, false),
    				listen_dev(div, "wheel", /*wheel_handler_2*/ ctx[23], false, false, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				listen_dev(button0, "click", /*click_handler_6*/ ctx[24], false, false, false),
    				listen_dev(button1, "click", /*click_handler_7*/ ctx[25], false, false, false),
    				listen_dev(div, "wheel", /*wheel_handler_3*/ ctx[26], false, false, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("selectedUnix" in $$props) $$invalidate(9, selectedUnix = $$props.selectedUnix);
    		if ("tempDate" in $$props) $$invalidate(13, tempDate = $$props.tempDate);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*selectedUnix*/ 512) {
    ...
    class TimeView extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { selectedUnix: 9 });
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!span_intro) span_intro = create_in_transition(span, /*fadeIn*/ ctx[10], { duration: /*animateSpeed*/ ctx[14] });
    				span_intro.start();
    			});
    ...
    function create_if_block_2$2(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen_dev(button, "click", /*click_handler*/ ctx[27], false, false, false);
    		},
    		p: function update(ctx, dirty) {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!button_intro) button_intro = create_in_transition(button, /*fadeIn*/ ctx[10], { duration: /*animateSpeed*/ ctx[14] });
    				button_intro.start();
    			});
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!button_intro) button_intro = create_in_transition(button, /*fadeIn*/ ctx[10], {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("transitionDirectionForward" in $$props) transitionDirectionForward = $$props.transitionDirectionForward;
    		if ("selectedYear" in $$props) $$invalidate(19, selectedYear = $$props.selectedYear);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$dateObject, viewUnix*/ 1081344) {
    			 $$invalidate(19, selectedYear = new $dateObject(viewUnix).year());
    		}
    		...
    		if ($$self.$$.dirty & /*$dateObject, selectedYear*/ 1572864) {
    		...
    		if ($$self.$$.dirty & /*$config, viewUnix, $dateObject*/ 9469952) {
    		...
    		if ($$self.$$.dirty & /*viewUnix, selectedYear, cachedViewUnix, $config*/ 9076736) {
    			 {
    				if (viewUnix) {
    	...
    	const block = {
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				...
    				if (!div_intro) div_intro = create_in_transition(div, /*fadeIn*/ ctx[8], {
    		...
    		o: function outro(local) {
    			...
    			div_outro = create_out_transition(div, /*fadeOut*/ ctx[7], {
    				duration: /*animateSpeed*/ ctx[9],
    				offset: 10
    			});
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	const dateObject = getContext("dateObject");
    	validate_store(dateObject, "dateObject");
    	component_subscribe($$self, dateObject, value => $$invalidate(14, $dateObject = value));
    	const config = getContext("config");
    	validate_store(config, "config");
    	component_subscribe($$self, config, value => $$invalidate(2, $config = value));
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("visible" in $$props) $$invalidate(0, visible = $$props.visible);
    		if ("animateSpeed" in $$props) $$invalidate(9, animateSpeed = $$props.animateSpeed);
    		if ("cachedSelectedUnix" in $$props) $$invalidate(12, cachedSelectedUnix = $$props.cachedSelectedUnix);
    		if ("transitionDirectionForward" in $$props) transitionDirectionForward = $$props.transitionDirectionForward;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$config, selectedUnix, $dateObject*/ 18436) {
    		...
    		if ($$self.$$.dirty & /*selectedDate, selectedUnix, cachedSelectedUnix, $config*/ 6156) {
    			 if (selectedDate) {
    				...
    				$$invalidate(12, cachedSelectedUnix = selectedUnix);
    ...
    class Infobox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { viewUnix: 10, selectedUnix: 11 });
    ...
    function create_if_block_5(ctx) {
    	...
    	let if_block0 = /*viewMode*/ ctx[0] !== "time" && create_if_block_7(ctx);
    	let if_block1 = /*viewMode*/ ctx[0] === "time" && create_if_block_6(ctx);
    ...
    function create_if_block_7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$6, 3, 3, 123);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block_6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-toolbox-button");
    			add_location(button, file$6, 10, 3, 271);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block_4$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-toolbox-button");
    			add_location(button, file$6, 18, 1, 438);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block_3$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-toolbox-button");
    			add_location(button, file$6, 26, 3, 622);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block_2$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-toolbox-button");
    			add_location(button, file$6, 33, 3, 799);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_if_block$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "pwt-date-toolbox-button");
    			add_location(button, file$6, 41, 1, 975);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			if (remount) dispose();
    ...
    function create_fragment$6(ctx) {
    	...
    	let t1;
    	let t2;
    	let if_block0 = /*$config*/ ctx[1].timePicker.enabled && !/*$config*/ ctx[1].onlyTimePicker && create_if_block_5(ctx);
    	let if_block1 = /*$config*/ ctx[1].toolbox.todayButton.enabled && create_if_block_4$2(ctx);
    	let if_block2 = /*$config*/ ctx[1].toolbox.calendarSwitch.enabled && create_if_block_1$4(ctx);
    	let if_block3 = /*$config*/ ctx[1].toolbox.submitButton.enabled && create_if_block$6(ctx);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("viewUnix" in $$props) $$invalidate(6, viewUnix = $$props.viewUnix);
    		if ("viewMode" in $$props) $$invalidate(0, viewMode = $$props.viewMode);
    		if ("yearRange" in $$props) $$invalidate(7, yearRange = $$props.yearRange);
    		if ("startYear" in $$props) $$invalidate(8, startYear = $$props.startYear);
    		if ("selectedYear" in $$props) $$invalidate(9, selectedYear = $$props.selectedYear);
    		if ("selectedMonth" in $$props) selectedMonth = $$props.selectedMonth;
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*viewUnix*/ 64) {
    			 $$invalidate(9, selectedYear = new persianDate(viewUnix).year());
    		}
    		...
    		if ($$self.$$.dirty & /*selectedYear, yearRange, startYear*/ 896) {
    			 {
    				$$invalidate(7, yearRange = []);
    				$$invalidate(8, startYear = selectedYear - selectedYear % 12);
    				let i = 0;
    ...
    class Toolbox extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { viewUnix: 6, viewMode: 0 });
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, isDirty, value => $$invalidate(8, $isDirty = value));
    	const selectedUnix = getContext("selectedUnix");
    	validate_store(selectedUnix, "selectedUnix");
    	component_subscribe($$self, selectedUnix, value => $$invalidate(9, $selectedUnix = value));
    		...
    		if (!config.overlay) {
    			...
    			let set = () => {
    				if (plotarea && originalContainer && originalContainer.tagName === "INPUT") {
    					$$invalidate(5, plotarea.style.position = "absolute", plotarea);
    					$$invalidate(5, plotarea.style.left = originalContainer.offsetLeft + configLeft + "px", plotarea);
    					$$invalidate(5, plotarea.style.top = parseInt(originalContainer.offsetTop) + configTop + parseInt(originalContainer.clientHeight) + document.body.scrollTop + "px", plotarea);
    				}
    			};
    	...
    	let updateInputs = function () {
    		if (originalContainer && originalContainer.tagName === "INPUT" && $config.initialValue || $isDirty) {
    			...
    			if (originalContainer && originalContainer.tagName === "INPUT") {
    				$$invalidate(4, originalContainer.value = selected, originalContainer);
    			}
    	...
    	$$self.$set = $$props => {
    		if ("originalContainer" in $$props) $$invalidate(4, originalContainer = $$props.originalContainer);
    		if ("plotarea" in $$props) $$invalidate(5, plotarea = $$props.plotarea);
    		if ("setPlotPostion" in $$props) $$invalidate(6, setPlotPostion = $$props.setPlotPostion);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("updateInputs" in $$props) $$invalidate(14, updateInputs = $$props.updateInputs);
    ...
    class Input extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*originalContainer*/ ctx[4] === undefined && !("originalContainer" in props)) {
    			console.warn("<Input> was created without expected prop 'originalContainer'");
    		}

    		if (/*plotarea*/ ctx[5] === undefined && !("plotarea" in props)) {
    ...
    function create_if_block$7(ctx) {
    	...
    	let current;
    	let dispose;
    	let if_block0 = /*$config*/ ctx[4].overlay && create_if_block_10(ctx);
    	let if_block1 = /*$config*/ ctx[4].infobox.enabled && create_if_block_9(ctx);
    	let if_block2 = /*$config*/ ctx[4].navigator.enabled && create_if_block_8(ctx);
    	let if_block3 = !/*$config*/ ctx[4].onlyTimePicker && create_if_block_3$4(ctx);
    	let if_block4 = /*$config*/ ctx[4].onlyTimePicker && create_if_block_2$4(ctx);
    	let if_block5 = /*$config*/ ctx[4].toolbox.enabled && create_if_block_1$5(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 25, 2, 698);

    			attr_dev(div1, "class", div1_class_value = /*$config*/ ctx[4].overlay
    			? "pwt-datepicker pwt-datepicker--overlay"
    			: "pwt-datepicker");

    			add_location(div1, file$7, 5, 1, 148);
    		},
    		m: function mount(target, anchor, remount) {
    			if (if_block0) if_block0.m(target, anchor);
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen_dev(div1, "wheel", /*handleWheel*/ ctx[26], false, false, false);
    		},
    		p: function update(ctx, dirty) {
    			if (/*$config*/ ctx[4].overlay) {
    				if (if_block0) ; else {
    			...
    			if (!current || dirty[0] & /*$config*/ 16 && div1_class_value !== (div1_class_value = /*$config*/ ctx[4].overlay
    			? "pwt-datepicker pwt-datepicker--overlay"
    			: "pwt-datepicker")) {
    ...
    function create_if_block_10(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 3, 2, 94);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    // (11:2) {#if $config.infobox.enabled}
    function create_if_block_9(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(11:2) {#if $config.infobox.enabled}",
    		ctx
    	});
    ...
    // (16:2) {#if $config.navigator.enabled}
    function create_if_block_8(ctx) {
    	...
    	navigator.$on("selectmode", /*setViewModeToUpperAvailableLevel*/ ctx[25]);
    	navigator.$on("today", /*today*/ ctx[22]);
    	navigator.$on("next", /*navNext*/ ctx[23]);
    	navigator.$on("prev", /*navPrev*/ ctx[24]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(16:2) {#if $config.navigator.enabled}",
    		ctx
    	});
    ...
    function create_if_block_3$4(ctx) {
    	...
    	let current;
    	let if_block0 = /*$privateViewMode*/ ctx[7] === "year" && /*$config*/ ctx[4].yearPicker.enabled && create_if_block_7$1(ctx);
    	let if_block1 = /*$privateViewMode*/ ctx[7] === "month" && /*$config*/ ctx[4].monthPicker.enabled && create_if_block_6$1(ctx);
    	let if_block2 = /*$privateViewMode*/ ctx[7] === "day" && /*$config*/ ctx[4].dayPicker.enabled && create_if_block_5$1(ctx);
    	let if_block3 = /*$privateViewMode*/ ctx[7] === "time" && create_if_block_4$3(ctx);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (/*$privateViewMode*/ ctx[7] === "year" && /*$config*/ ctx[4].yearPicker.enabled) {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);

    					if (dirty[0] & /*$privateViewMode, $config*/ 144) {
    						transition_in(if_block0, 1);
    					}
    				} else {
    			...
    			if (/*$privateViewMode*/ ctx[7] === "month" && /*$config*/ ctx[4].monthPicker.enabled) {
    				if (if_block1) {
    					if_block1.p(ctx, dirty);
    			...
    			if (/*$privateViewMode*/ ctx[7] === "day" && /*$config*/ ctx[4].dayPicker.enabled) {
    				if (if_block2) {
    					if_block2.p(ctx, dirty);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(28:3) {#if !$config.onlyTimePicker}",
    		ctx
    	});
    ...
    // (29:4) {#if $privateViewMode === 'year' && $config.yearPicker.enabled}
    function create_if_block_7$1(ctx) {
    	...
    	yearview.$on("select", /*onSelectYear*/ ctx[21]);

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(yearview.$$.fragment);
    			add_location(div, file$7, 29, 5, 851);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { duration: /*animateSpeed*/ ctx[13] }, true);
    		...
    		o: function outro(local) {
    			...
    			if (!div_transition) div_transition = create_bidirectional_transition(div, fade, { duration: /*animateSpeed*/ ctx[13] }, false);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(29:4) {#if $privateViewMode === 'year' && $config.yearPicker.enabled}",
    		ctx
    	});
    ...
    // (38:4) {#if $privateViewMode === 'month' && $config.monthPicker.enabled}
    function create_if_block_6$1(ctx) {
    	...
    	monthview.$on("select", /*onSelectMonth*/ ctx[20]);

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(monthview.$$.fragment);
    			add_location(div, file$7, 38, 5, 1124);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(38:4) {#if $privateViewMode === 'month' && $config.monthPicker.enabled}",
    		ctx
    	});
    ...
    function create_if_block_5$1(ctx) {
    	...
    	dateview.$on("prev", /*navPrev*/ ctx[24]);
    	dateview.$on("next", /*navNext*/ ctx[23]);
    	dateview.$on("selectDate", /*onSelectDate*/ ctx[18]);

    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(dateview.$$.fragment);
    			add_location(div, file$7, 47, 5, 1395);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_if_block_4$3(ctx) {
    	...
    	timeview.$on("selectTime", /*onSelectTime*/ ctx[19]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(58:4) {#if $privateViewMode === 'time'}",
    		ctx
    	});
    ...
    function create_if_block_2$4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(64:3) {#if $config.onlyTimePicker}",
    		ctx
    	});
    ...
    // (70:2) {#if $config.toolbox.enabled}
    function create_if_block_1$5(ctx) {
    	...
    	toolbox.$on("setcalendar", /*setcalendar*/ ctx[17]);
    	toolbox.$on("selectmode", /*setViewMode*/ ctx[16]);
    	toolbox.$on("today", /*today*/ ctx[22]);
    	toolbox.$on("next", /*navNext*/ ctx[23]);
    	toolbox.$on("prev", /*navPrev*/ ctx[24]);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(70:2) {#if $config.toolbox.enabled}",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	input.$on("setinitialvalue", /*setInitialValue*/ ctx[15]);
    	input.$on("setvisibility", /*setvisibility*/ ctx[14]);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	const _actions = {
    		...
    		parsInitialValue(inputString) {
    			let pd = get_store_value(_dateObject);
    			let parse = new PersianDateParser();

    			if (parse.parse(inputString) !== undefined) {
    				pd.toCalendar(get_store_value(_config).initialValueType);
    				let unix = new pd(parse.parse(inputString));
    				this.updateIsDirty(true);
    				_viewUnix.set(unix.valueOf());
    				this.setSelectedDate(unix);
    				pd.toCalendar(get_store_value(_config).calendarType);
    			}
    		},
    		...
    		onSetCalendar(payload) {
    			_config.set({ ...get_store_value(_config), calendarType: payload });
    			let currentLocale = get_store_value(_config).calendar[payload].locale;
    			let obj = persianDate;
    			obj.toCalendar(payload);
    			obj.toLocale(currentLocale);
    			obj.toLeapYearMode(get_store_value(_config).calendar.persian.leapYearMode);
    			_dateObject.set(obj);
    			_viewUnix.set(get_store_value(_selectedUnix));
    		},
    		setConfig(payload) {
    			_config.set(payload);
    			this.onSetCalendar(get_store_value(_config).calendarType);
    		...
    		updateConfig(key) {
    			let ob = {};
    			ob[key[0]] = key[1];
    			let conf = JSON.stringify(get_store_value(_config));
    			conf = JSON.parse(conf);
    			conf[key[0]] = key[1];

    			_config.update(() => {
    				return { ...get_store_value(_config), ...ob };
    			});

    			this.onSetCalendar(get_store_value(_config).calendarType);
    		},
    		onSelectTime(pDate) {
    			const pd = get_store_value(_dateObject);
    			const date = pDate.detail;
    			const { hour, minute, second } = getHourMinuteSecond(date);
    			const calced = new pd(get_store_value(_selectedUnix)).hour(hour).minute(minute).second(second);
    			this.updateIsDirty(true);
    			this.setSelectedDate(calced);
    		},
    		onSelectDate(pDate) {
    			const pd = get_store_value(_dateObject);
    			const { hour, minute, second } = getHourMinuteSecond(get_store_value(_selectedUnix));
    		...
    		setSelectedDate(pDate) {
    			...
    			get_store_value(_config).onSelect(unix);
    		},
    		onSelectMonth(month) {
    			const pd = get_store_value(_dateObject);
    			_viewUnix.set(new pd(get_store_value(_viewUnix)).month(month).valueOf());

    			if (!get_store_value(_config).onlySelectOnDate) {
    				this.setSelectedDate(new pd(get_store_value(_viewUnix)).month(month));
    			} else {
    				this.setViewModeToLowerAvailableLevel();
    			}
    		...
    		onSelectYear(year) {
    			const pd = get_store_value(_dateObject);
    			_viewUnix.set(new pd(get_store_value(_selectedUnix)).year(year).valueOf());

    			if (!get_store_value(_config).onlySelectOnDate) {
    				this.setSelectedDate(new pd(get_store_value(_selectedUnix)).year(year));
    			} else {
    				this.setViewModeToLowerAvailableLevel();
    			}
    		...
    		onSetHour(hour) {
    			const pd = get_store_value(_dateObject);
    			this.setSelectedDate(new pd(get_store_value(_selectedUnix)).hour(hour));
    			this.updateIsDirty(true);
    		},
    		onSetMinute(minute) {
    			const pd = get_store_value(_dateObject);
    			this.setSelectedDate(new pd(get_store_value(_selectedUnix)).minute(minute));
    			this.updateIsDirty(true);
    		},
    		setSecond(second) {
    			const pd = get_store_value(_dateObject);
    			this.setSelectedDate(new pd(get_store_value(_selectedUnix)).second(second));
    		},
    		setViewMode(mode) {
    			let conf = get_store_value(_config);
    			_config.set(lodash.merge(conf, { viewMode: mode }));
    			_privateViewMode.set(mode);
    		},
    		setViewModeToUpperAvailableLevel() {
    			let currentViewMode = get_store_value(_privateViewMode);
    			let $_config = get_store_value(_config);
    		...
    		onSelectNextView() {
    			if (get_store_value(_privateViewMode) === "day") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).add("month", 1)));
    			}

    			if (get_store_value(_privateViewMode) === "month") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).add("year", 1)));
    			}

    			if (get_store_value(_privateViewMode) === "year") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).add("year", 12)));
    			}
    		},
    		onSelectPrevView() {
    			if (get_store_value(_privateViewMode) === "day") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).subtract("month", 1)));
    			}

    			if (get_store_value(_privateViewMode) === "month") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).subtract("year", 1)));
    			}

    			if (get_store_value(_privateViewMode) === "year") {
    				_viewUnix.set(persianDateToUnix(new persianDate(get_store_value(_viewUnix)).subtract("year", 12)));
    			}
    		},
    		setViewUnix(pDate) {
    	...
    	const setvisibility = function (payload) {
    		$$invalidate(3, isVisible = payload);
    	...
    	$$self.$set = $$props => {
    		if ("options" in $$props) $$invalidate(27, options = $$props.options);
    		if ("originalContainer" in $$props) $$invalidate(0, originalContainer = $$props.originalContainer);
    		if ("model" in $$props) $$invalidate(28, model = $$props.model);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("originalContainer" in $$props) $$invalidate(0, originalContainer = $$props.originalContainer);
    		if ("model" in $$props) $$invalidate(28, model = $$props.model);
    		if ("cashedoptions" in $$props) $$invalidate(37, cashedoptions = $$props.cashedoptions);
    		if ("cashedSelectedDate" in $$props) $$invalidate(38, cashedSelectedDate = $$props.cashedSelectedDate);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*options*/ 134217728 | $$self.$$.dirty[1] & /*cashedoptions*/ 64) {
    			 {
    				if (JSON.stringify(cashedoptions) !== JSON.stringify(options)) {
    					if (!options) {
    						$$invalidate(27, options = defaultconfig);
    					} else {
    						$$invalidate(27, options = lodash.merge(defaultconfig, options));
    					}

    					dispatcher("setConfig")(options);
    					$$invalidate(37, cashedoptions = options);
    				}
    			}
    		}

    		if ($$self.$$.dirty[0] & /*model, $selectedUnix*/ 268435488 | $$self.$$.dirty[1] & /*cashedSelectedDate*/ 128) {
    			 {
    				if (model && model !== cashedSelectedDate) {
    					dispatcher("setDate")(parseInt(model));
    					$$invalidate(38, cashedSelectedDate = $selectedUnix);
    				}
    			}
    		}
    	};
