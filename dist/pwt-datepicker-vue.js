...
function create_if_block$7(ctx) {
	...
	let current;
	let dispose;
	let if_block0 = /*$config*/ ctx[4].infobox.enabled && create_if_block_9(ctx);
	let if_block1 = /*$config*/ ctx[4].navigator.enabled && create_if_block_8(ctx);
	let if_block2 = !/*$config*/ ctx[4].onlyTimePicker && create_if_block_3$4(ctx);
	let if_block3 = /*$config*/ ctx[4].onlyTimePicker && create_if_block_2$4(ctx);
...
function create_if_block_6$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 34, 6, 1001);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_5$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 43, 6, 1281);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
...
function create_if_block_4$3(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(54:5) {#if $privateViewMode === 'time'}",
		ctx
	});
...
function create_if_block_2$4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(60:4) {#if $config.onlyTimePicker}",
		ctx
	});
...
// (66:3) {#if $config.toolbox.enabled}
function create_if_block_1$5(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(66:3) {#if $config.toolbox.enabled}",
		ctx
	});
