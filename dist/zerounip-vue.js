...
function create_fragment$4(ctx) {
	...
	let if_block4 = ctx.viewMode === "time" && create_if_block$2(ctx);
...
function create_if_block$5(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div0, file$7, 24, 3, 584);
			attr_dev(div1, "class", "pwt-datepicker");
			add_location(div1, file$7, 5, 1, 85);
...
// (10:2) {#if $config.infobox.enabled}
function create_if_block_8$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(10:2) {#if $config.infobox.enabled}",
		ctx
	});
...
// (15:3) {#if $config.navigator.enabled}
function create_if_block_7$1(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(15:3) {#if $config.navigator.enabled}",
		ctx
	});
...
// (27:4) {#if !$config.onlyTimePicker}
function create_if_block_3$4(ctx) {
	let t0;
	let t1;
	let if_block2_anchor;
	let current;
	let if_block0 = ctx.$privateViewModeDerived === "year" && ctx.$config.yearPicker.enabled && create_if_block_6$2(ctx);
	let if_block1 = ctx.$privateViewModeDerived === "month" && ctx.$config.monthPicker.enabled && create_if_block_5$2(ctx);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(27:4) {#if !$config.onlyTimePicker}",
		ctx
	});
...
// (28:5) {#if $privateViewModeDerived === 'year' && $config.yearPicker.enabled}
function create_if_block_6$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 28, 6, 748);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(28:5) {#if $privateViewModeDerived === 'year' && $config.yearPicker.enabled}",
		ctx
	});
...
// (37:5) {#if $privateViewModeDerived === 'month' && $config.monthPicker.enabled}
function create_if_block_5$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 37, 6, 1026);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(37:5) {#if $privateViewModeDerived === 'month' && $config.monthPicker.enabled}",
		ctx
	});
...
// (46:5) {#if $privateViewModeDerived === 'day' && $config.dayPicker.enabled}
function create_if_block_4$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 46, 6, 1302);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(46:5) {#if $privateViewModeDerived === 'day' && $config.dayPicker.enabled}",
		ctx
	});
...
// (58:4) {#if ($privateViewModeDerived === 'time' && $config.timePicker.enabled) || $config.onlyTimePicker}
function create_if_block_2$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$7, 58, 5, 1673);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(58:4) {#if ($privateViewModeDerived === 'time' && $config.timePicker.enabled) || $config.onlyTimePicker}",
		ctx
	});
...
// (67:3) {#if $config.toolbox.enabled}
function create_if_block_1$4(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "if",
		source: "(67:3) {#if $config.toolbox.enabled}",
		ctx
	});
...
function create_fragment$8(ctx) {
	let pre;
	let t0_value = ctx.$config.navigator.enabled + "";
	let t0;
	let t1;
	let t2_value = ctx.$config.calendarType + "";
	let t2;
	let t3;
	let t4;
	let current;
	...
	const block = {
		...
		p: function update(changed, ctx) {
			if ((!current || changed.$config) && t0_value !== (t0_value = ctx.$config.navigator.enabled + "")) set_data_dev(t0, t0_value);
			if ((!current || changed.$config) && t2_value !== (t2_value = ctx.$config.calendarType + "")) set_data_dev(t2, t2_value);
